    ...
    @section('upcoming')
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <!-- Show More Link -->
                <a href="{{ route('browse-movies') }}" class="text-blue-500 cursor-pointer hover:underline">Show More</a>
            </div>
            <!-- Movie Cards Section -->
            <div class="flex gap-6 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                <!-- Movie Card -->
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex justify-between items-center mb-4">
                <!-- Main Heading -->
                <h2 class="text-2xl font-bold text-gray-800">Concerts</h2>
                
                <!-- Show More Link -->
                <a href="{{ route('browse-concerts') }}" class="text-blue-500 cursor-pointer hover:underline">Show More</a>
            </div>
            <!-- Movie Cards Section -->
            <div class="flex gap-6 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                <!-- Movie Card -->
